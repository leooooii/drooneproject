...
function builddrone(){
  ...
  var box = new THREE.Mesh(new THREE.BoxGeometry(0.3, 0.2, 0.6), new THREE.MeshBasicMaterial({
    color: 0x444444, 
    map: texture
  }));
  box.castShadow = true;
...
point[1] =new THREE.Mesh(new THREE.CylinderGeometry(0, 0.04, 0.04, 30), new THREE.MeshPhongMaterial({color:0xffff00}));
SpeedCylinder[1] = new THREE.Mesh(new THREE.CylinderGeometry(.03,.03, .30, 30), new THREE.MeshPhongMaterial({color:0xffff00}));
///////////motor1
point[0] =new THREE.Mesh(new THREE.CylinderGeometry(0, .04, .04, 40), new THREE.MeshPhongMaterial({color:0xff0000}));
SpeedCylinder[0] = new THREE.Mesh(new THREE.CylinderGeometry(.03, .03, .60, 30), new THREE.MeshPhongMaterial({color:0xff0000}));
////////////mnotor2
point[3] =new THREE.Mesh(new THREE.CylinderGeometry(0, .04, .04, 40), new THREE.MeshPhongMaterial({color:0xffff00}));
SpeedCylinder[3] = new THREE.Mesh(new THREE.CylinderGeometry(.03, .03, .30, 30), new THREE.MeshPhongMaterial({color:0xffff00}));
/////////motor
point[2] =new THREE.Mesh(new THREE.CylinderGeometry(0, .04, .04, 30), new THREE.MeshPhongMaterial({color:0xff0000}));
SpeedCylinder[2] = new THREE.Mesh(new THREE.CylinderGeometry(.03, .03, .60, 30), new THREE.MeshPhongMaterial({color:0xff0000}));
/////////motor4

for(i=0;i<4;i++){
SpeedCylinder[i].add(point[i]);
//  SpeedCylinder[i].rotation.x=Math.PI/2;
motorCenters2[i].add(SpeedCylinder[i]);
}
point[1].position.y=0.16;
    SpeedCylinder[1].position.y=0.35;

      point[0].position.y=0.31;
    SpeedCylinder[0].position.y=0.50;

        point[3].position.y=.16;
    SpeedCylinder[3].position.y=0.35;

        point[2].position.y=0.31;
    SpeedCylinder[2].position.y=0.50;
...
var head =  new THREE.Geometry();
  ...
  Head = new THREE.Mesh(head, new THREE.MeshBasicMaterial({
    color: 0x444444, 
    map : texture
  }));
  ...
  top.faces.push(face2);
  Top = new THREE.Mesh(top, new THREE.MeshBasicMaterial({
    color: 0x444444, 
    //map : texture
  }));
  bodybox.add(Top)
